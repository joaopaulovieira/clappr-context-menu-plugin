var drawChart = (function () {
  ...
  const SunBurst = ({
    ...
    const [selectedNode, setSelectedNode] = m$1(null);
  ...
  const Chart = ({
    ...
    const [tooltipNode, setTooltipNode] = m$1(root);
    const [highlightedNodes, setHighlightedNodes] = m$1(root.descendants());
  ...
  const Main = ({ width, height, data: { tree, nodes, options = {} } }) => {
    ...
    const [sizeProperty, setSizeProperty] = m$1(availableSizeProperties[0]);
